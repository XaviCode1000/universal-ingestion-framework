---
url: https://geminicli.com/docs/architecture
...
, orchestrates interactions with the
...
**Interaction:** `packages/core`

invokes these tools based on requests
from the Gemini model.

A typical interaction with the Gemini CLI follows this flow:

**User input:** The user types a prompt or command into the terminal, which
is managed by `packages/cli`

.
**Request to core:** `packages/cli`
...
**Gemini API response:** The Gemini API processes the prompt and returns a
...
**Response to CLI:** The core package sends the final response back to the
CLI package.
**Display to user:** The CLI package formats and displays the response to
