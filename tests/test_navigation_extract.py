...
class TestExtractLinks:
    ...
    def test_strips_fragments(self):
        ...
        mock_parser.css = MagicMock(
            side_effect=lambda selector: (
                [MagicMock(__str__=lambda s: "/page#section")]
                if "href" in selector
                else []
            )
        )
    ...
    def test_deduplicates_links(self):
        ...
        mock_parser.css = MagicMock(
            side_effect=lambda selector: (
                [MagicMock(__str__=lambda s: "/page1") for _ in range(3)]
                if "href" in selector
                else []
            )
        )
        ...
        mock_parser.css = MagicMock(
            side_effect=lambda selector: (
                ...
                if "href" in selector
                    ...
                    MagicMock(__str__=lambda s: "/image.png"),
                    MagicMock(__str__=lambda s: "/photo.jpg"),
                ]
            )
        )
    ...
    def test_relative_urls_resolved(self):
        ...
        mock_parser.css = MagicMock(
            side_effect=lambda selector: (
                [MagicMock(__str__=lambda s: "../other/page.html")]
                if "href" in selector
                else []
            )
        )
